              ...
              <div class="col-md-6" style="text-align: center; margin-left: 10px">
               ...
               while ($row=mysqli_fetch_array($result)) { ?>
                ...
                <div >
                  ...
                  <div class="col-md-8" style="text-align: left;">
                    <p><?php echo $row['working_month_or_day_number'] . " ". $row['working_duration']; ?> </p>
                  </div>
                </div>
                ...
                <div>
                 ...
                 <!--   <a href="<?php //echo 'recentPostEdit.php?id='.$row['id_post'] ?>">
                    <button style="width: 100px; height: 50px; background: #892089; color: white">Edit Post </button>
                  </a> -->
